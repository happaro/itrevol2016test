...
namespace GooglePlayGames {
    ...
    public class PlayGamesPlatform : ISocialPlatform {
        ...
        public void ShowAchievementsUI () {
            ...
            GooglePlayGames.OurUtils.Logger.d("ShowAchievementsUI");
        ...
        public void ShowLeaderboardUI () {
            ...
            GooglePlayGames.OurUtils.Logger.d("ShowLeaderboardUI");
        ...
        public void ShowLeaderboardUI(string lbId) {
            ...
            GooglePlayGames.OurUtils.Logger.d("ShowLeaderboardUI, lbId=" + lbId);
            if (lbId != null) {
                lbId = MapId(lbId);
            }
