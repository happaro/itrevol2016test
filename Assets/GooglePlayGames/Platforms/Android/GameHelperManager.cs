...
namespace GooglePlayGames.Android {
    internal class GameHelperManager {
        ...
        internal GameHelperManager(AndroidClient client) {
            ...
            GooglePlayGames.OurUtils.Logger.d("Setting up GameHelperManager.");

            // create GameHelper
            GooglePlayGames.OurUtils.Logger.d("GHM creating GameHelper.");
            int flags = JavaConsts.GAMEHELPER_CLIENT_ALL;
            GooglePlayGames.OurUtils.Logger.d("GHM calling GameHelper constructor with flags=" + flags);
            ...
            GooglePlayGames.OurUtils.Logger.d("GHM setting up GameHelper.");
            mGameHelper.Call("enableDebugLog", GooglePlayGames.OurUtils.Logger.DebugLogEnabled);
            ...
            GooglePlayGames.OurUtils.Logger.d("GHM Setting GameHelper options.");
            ...
            GooglePlayGames.OurUtils.Logger.d("GHM calling GameHelper.setup");
            mGameHelper.Call("setup", listenerProxy);
            GooglePlayGames.OurUtils.Logger.d("GHM: GameHelper setup done.");

            // set up callbacks so we're informed of pause/unpause events
            GooglePlayGames.OurUtils.Logger.d("GHM Setting up lifecycle.");
            ...
            // start initial auth
            GooglePlayGames.OurUtils.Logger.d("GHM calling GameHelper.onStart to try initial auth.");
            mGameHelper.Call("onStart", mAndroidClient.GetActivity());
        }

        void OnResume() {
        	mPaused = false;
            GooglePlayGames.OurUtils.Logger.d("GHM got OnResume, relaying to GameHelper");
            mGameHelper.Call("onStart", mAndroidClient.GetActivity());
        }

        void OnPause() {
            GooglePlayGames.OurUtils.Logger.d("GHM got OnPause, relaying to GameHelper");
            mPaused = true;
        ...
        void OnSignInFailed(int origin) {
            GooglePlayGames.OurUtils.Logger.d("GHM got onSignInFailed, origin " + origin + ", notifying AndroidClient.");
            
            // if the origin is the Sign In Helper activity, check if there's an error to show
            if (origin == ORIGIN_SIGN_IN_HELPER_ACTIVITY) {
                GooglePlayGames.OurUtils.Logger.d("GHM got onSignInFailed from Sign In Helper. Showing error message.");
                ...
                GooglePlayGames.OurUtils.Logger.d("Error message shown.");
            }
        ...
        void OnSignInSucceeded(int origin) {
            GooglePlayGames.OurUtils.Logger.d("GHM got onSignInSucceeded, origin " + origin + ", notifying AndroidClient.");
            if (origin == ORIGIN_MAIN_ACTIVITY) {
                ...
                GooglePlayGames.OurUtils.Logger.d("GHM got helper's OnSignInSucceeded.");
        ...
        internal void BeginUserInitiatedSignIn() {
            GooglePlayGames.OurUtils.Logger.d("GHM Starting user-initiated sign in.");
            ...
            GooglePlayGames.OurUtils.Logger.d("Forcing GameHelper's connect-on-start flag to true.");
            ...
            GooglePlayGames.OurUtils.Logger.d("GHM launching sign-in Activity via SignInHelperManager.launchSignIn");
        ...
        public void ClearInvitationAndTurnBasedMatch() {
            GooglePlayGames.OurUtils.Logger.d("GHM clearing invitation and turn-based match on GameHelper.");
        ...
        public void SignOut() {
            GooglePlayGames.OurUtils.Logger.d("GHM SignOut");
        ...
        private class GameHelperListener : AndroidJavaProxy {
            ...
            void onSignInFailed() {
                GooglePlayGames.OurUtils.Logger.d("GHM/GameHelperListener got onSignInFailed, origin " +
                        mOrigin + ", notifying GHM.");
                mContainer.OnSignInFailed(mOrigin);
            }
            void onSignInSucceeded() {
                GooglePlayGames.OurUtils.Logger.d("GHM/GameHelperListener got onSignInSucceeded, origin " +
                        mOrigin + ", notifying GHM.");
