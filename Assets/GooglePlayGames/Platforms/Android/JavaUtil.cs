    ...
    internal class JavaUtil {
        ...
        public static AndroidJavaClass GetClass(string className) {
            ...
            try {
                ...
                GooglePlayGames.OurUtils.Logger.e("JavaUtil failed to load Java class: " + className);
                throw ex;
            }
        }
        ...
        public static TurnBasedMatch.MatchStatus ConvertMatchStatus(int code) {
            ...
            default:
                GooglePlayGames.OurUtils.Logger.e("Unknown match status code: " + code);
        ...
        public static TurnBasedMatch.MatchTurnStatus ConvertTurnStatus(int code) {
            ...
            default:
                GooglePlayGames.OurUtils.Logger.e("Unknown match turn status: " + code);
        ...
        public static TurnBasedMatch ConvertMatch(string playerId, AndroidJavaObject matchObj) {
            ...
            GooglePlayGames.OurUtils.Logger.d("AndroidTbmpClient.ConvertMatch, playerId=" + playerId);
