...
namespace GooglePlayGames.Android {
    internal class AndroidRtmpClient : IRealTimeMultiplayerClient {
        ...
        public void CreateQuickGame(int minOpponents, int maxOpponents, int variant,
            ...
            GooglePlayGames.OurUtils.Logger.d(string.Format("AndroidRtmpClient.CreateQuickGame, opponents={0}-{1}, " + 
        ...
        public void CreateWithInvitationScreen(int minOpponents, int maxOpponents, int variant,
                RealTimeMultiplayerListener listener) {
            GooglePlayGames.OurUtils.Logger.d(string.Format("AndroidRtmpClient.CreateWithInvitationScreen, " + 
            ...
            mClient.CallClientApi("rtmp create with invitation screen", () => {
                ...
                klass.CallStatic("launch", true, mClient.GetActivity(),
                        new SelectOpponentsProxy(this), GooglePlayGames.OurUtils.Logger.DebugLogEnabled,
        ...
        public void AcceptFromInbox(RealTimeMultiplayerListener listener) {
            GooglePlayGames.OurUtils.Logger.d("AndroidRtmpClient.AcceptFromInbox.");
            ...
            mClient.CallClientApi("rtmp accept with inbox screen", () => {
                ...
                mLaunchedExternalActivity = true;
                klass.CallStatic("launch", true, mClient.GetActivity(),
                                 new InvitationInboxProxy(this), GooglePlayGames.OurUtils.Logger.DebugLogEnabled);
            }, (bool success) => {
                if (!success) {
        ...
        public void AcceptInvitation(string invitationId, RealTimeMultiplayerListener listener) {
            GooglePlayGames.OurUtils.Logger.d("AndroidRtmpClient.AcceptInvitation " + invitationId);
            ...
            mClient.CallClientApi("rtmp accept invitation", () => {
                GooglePlayGames.OurUtils.Logger.d("Accepting invite via support lib.");
                AndroidJavaClass rtmpUtil = JavaUtil.GetClass(JavaConsts.SupportRtmpUtilsClass);
        ...
        public void SendMessage(bool reliable, string participantId, byte[] data,
            ...
            GooglePlayGames.OurUtils.Logger.d(string.Format("AndroidRtmpClient.SendMessage, reliable={0}, " + 
            ...
            if (mSelf != null && mSelf.ParticipantId.Equals(participantId)) {
                GooglePlayGames.OurUtils.Logger.d("Ignoring request to send message to self, " + participantId);
                return;
            }
            ...
            mClient.CallClientApi("send message to " + participantId, () => {
                if (mRoom != null) {
                    ...
                    GooglePlayGames.OurUtils.Logger.w("Not sending message because real-time room was torn down.");
                }
            }, null);
        }
        ...
        public List<Participant> GetConnectedParticipants() {
            GooglePlayGames.OurUtils.Logger.d("AndroidRtmpClient.GetConnectedParticipants");
        ...
        public Participant GetParticipant(string id) {
            GooglePlayGames.OurUtils.Logger.d("AndroidRtmpClient.GetParticipant: " + id);
            ...
            if (allParticipants == null) {
                GooglePlayGames.OurUtils.Logger.e("RtmpGetParticipant called without a valid room!");
                return null;
            }
            ...
            GooglePlayGames.OurUtils.Logger.e("Participant not found in room! id: " + id);
            return null;
        }
        
        // called from game thread
        public Participant GetSelf() {
            GooglePlayGames.OurUtils.Logger.d("AndroidRtmpClient.GetSelf");
            ...
            if (self == null) {
                GooglePlayGames.OurUtils.Logger.e("Call to RtmpGetSelf() can only be made when in a room. Returning null.");
            }
            return self;
        }
        ...
        public void LeaveRoom() {
            GooglePlayGames.OurUtils.Logger.d("AndroidRtmpClient.LeaveRoom");
            ...
            if (mRtmpActive && mRoom == null) {
                GooglePlayGames.OurUtils.Logger.w("AndroidRtmpClient.LeaveRoom: waiting for room; deferring leave request.");
        ...
        public void OnStop() {
            ...
            if (mLaunchedExternalActivity) {
                GooglePlayGames.OurUtils.Logger.d("OnStop: EXTERNAL ACTIVITY is pending, so not clearing RTMP.");
            } else {
        ...
        public void DeclineInvitation(string invitationId) {
            GooglePlayGames.OurUtils.Logger.d("AndroidRtmpClient.DeclineInvitation " + invitationId);
            ...
            mClient.CallClientApi("rtmp decline invitation", () => {
                ...
                if (!success) {
                    GooglePlayGames.OurUtils.Logger.w("Failed to decline invitation. GoogleApiClient was disconnected");
                }
            });
        }
        ...
        private bool PrepareToCreateRoom(string method, RealTimeMultiplayerListener listener) {
            if (mRtmpActive) {
                GooglePlayGames.OurUtils.Logger.e("Cannot call " + method + " while a real-time game is active.");
                if (listener != null) {
                    GooglePlayGames.OurUtils.Logger.d("Notifying listener of failure to create room.");
        ...
        private bool CheckConnectedRoom(string method) {
            if (mRoom == null || !mDeliveredRoomConnected) {
                GooglePlayGames.OurUtils.Logger.e("Method " + method + " called without a connected room. " +
        ...
        private void Clear(string reason) {
            GooglePlayGames.OurUtils.Logger.d("RtmpClear: clearing RTMP (reason: " + reason + ").");
            
            // leave the room, if we have one
            if (mRoom != null) {
                GooglePlayGames.OurUtils.Logger.d("RtmpClear: Room still active, so leaving room.");
                string roomId = mRoom.Call<string>("getRoomId");
                GooglePlayGames.OurUtils.Logger.d("RtmpClear: room id to leave is " + roomId);
                ...
                GooglePlayGames.OurUtils.Logger.d("RtmpClear: left room.");
                mRoom = null;
            } else {
                GooglePlayGames.OurUtils.Logger.d("RtmpClear: no room active.");
            }
            
            // call the OnLeftRoom() callback if needed
            if (mDeliveredRoomConnected) {
                GooglePlayGames.OurUtils.Logger.d("RtmpClear: looks like we must call the OnLeftRoom() callback.");
                RealTimeMultiplayerListener listener = mRtmpListener;
                if (listener != null) {
                    GooglePlayGames.OurUtils.Logger.d("Calling OnLeftRoom() callback.");
                    PlayGamesHelperObject.RunOnGameThread(() => {
                        listener.OnLeftRoom();
                    });
                }
            } else {
                GooglePlayGames.OurUtils.Logger.d("RtmpClear: no need to call OnLeftRoom() callback.");
            }
            ...
            GooglePlayGames.OurUtils.Logger.d("RtmpClear: RTMP cleared.");
        }
        ...
        private void UpdateRoom() {
            ...
            GooglePlayGames.OurUtils.Logger.d("UpdateRoom: Updating our cached data about the room.");
            
            string roomId = mRoom.Call<string>("getRoomId");
            GooglePlayGames.OurUtils.Logger.d("UpdateRoom: room id: " + roomId);
            
            GooglePlayGames.OurUtils.Logger.d("UpdateRoom: querying for my player ID.");
            string playerId = mClient.GHManager.CallGmsApi<string>("games.Games", "Players",
                "getCurrentPlayerId");
            GooglePlayGames.OurUtils.Logger.d("UpdateRoom: my player ID is: " + playerId);
            GooglePlayGames.OurUtils.Logger.d("UpdateRoom: querying for my participant ID in the room.");
            string myPartId = mRoom.Call<string>("getParticipantId", playerId);
            GooglePlayGames.OurUtils.Logger.d("UpdateRoom: my participant ID is: " + myPartId);
            ...
            GooglePlayGames.OurUtils.Logger.d("UpdateRoom: # participants: " + participantCount);
            ...
            for (int i = 0; i < participantCount; i++) {
                GooglePlayGames.OurUtils.Logger.d("UpdateRoom: querying participant #" + i);
                string thisId = participantIds.Call<string>("get", i);
                GooglePlayGames.OurUtils.Logger.d("UpdateRoom: participant #" + i + " has id: " + thisId);
                ...
                if (p.ParticipantId.Equals(myPartId)) {
                    GooglePlayGames.OurUtils.Logger.d("Participant is SELF.");
                    mSelf = p;
                }
            ...
            if (mSelf == null) {
                GooglePlayGames.OurUtils.Logger.e("List of room participants did not include self, " + 
            ...
            lock (mParticipantListsLock) {
                ...
                GooglePlayGames.OurUtils.Logger.d("UpdateRoom: participant list now has " + mConnectedParticipants.Count + 
                         " participants.");
            }
            
            // cleanup
            GooglePlayGames.OurUtils.Logger.d("UpdateRoom: cleanup.");
            foreach (AndroidJavaObject obj in toDispose) {
                obj.Dispose();
            }
            
            GooglePlayGames.OurUtils.Logger.d("UpdateRoom: newly connected participants: " + newlyConnected.Length);
            GooglePlayGames.OurUtils.Logger.d("UpdateRoom: newly disconnected participants: " + newlyDisconnected.Length);
            ...
            if (mDeliveredRoomConnected) {
                if (newlyConnected.Length > 0 && mRtmpListener != null) {
                    GooglePlayGames.OurUtils.Logger.d("UpdateRoom: calling OnPeersConnected callback");
                    mRtmpListener.OnPeersConnected(newlyConnected);
                }
                if (newlyDisconnected.Length > 0 && mRtmpListener != null) {
                    GooglePlayGames.OurUtils.Logger.d("UpdateRoom: calling OnPeersDisconnected callback");
        ...
        private void FailRoomSetup(string reason) {
            GooglePlayGames.OurUtils.Logger.d("Failing room setup: " + reason);
            RealTimeMultiplayerListener listener = mRtmpListener;
            
            Clear("Room setup failed: " + reason);
            
            if (listener != null) {
                GooglePlayGames.OurUtils.Logger.d("Invoking callback OnRoomConnected(false) to signal failure.");
                PlayGamesHelperObject.RunOnGameThread(() => {
                    listener.OnRoomConnected(false);
                });
            }
        ...
        private bool CheckRtmpActive(string method) {
            if (!mRtmpActive) {
                GooglePlayGames.OurUtils.Logger.d("Got call to " + method + " with RTMP inactive. Ignoring.");
                return false;
            }
            return true;
        }
        ...
        private void OnJoinedRoom(int statusCode, AndroidJavaObject room) {
            GooglePlayGames.OurUtils.Logger.d("AndroidClient.OnJoinedRoom, status " + statusCode);
        ...
        private void OnLeftRoom(int statusCode, AndroidJavaObject room) {
            GooglePlayGames.OurUtils.Logger.d("AndroidClient.OnLeftRoom, status " + statusCode);
        ...
        private void OnRoomConnected(int statusCode, AndroidJavaObject room) {
            GooglePlayGames.OurUtils.Logger.d("AndroidClient.OnRoomConnected, status " + statusCode);
            ...
            if (statusCode != 0) {
                ...
                GooglePlayGames.OurUtils.Logger.d("AndroidClient.OnRoomConnected: room setup succeeded!");
                RealTimeMultiplayerListener listener = mRtmpListener;
                if (listener != null) {
                    GooglePlayGames.OurUtils.Logger.d("Invoking callback OnRoomConnected(true) to report success.");
                    PlayGamesHelperObject.RunOnGameThread(() => {
        ...
        private void OnRoomCreated(int statusCode, AndroidJavaObject room) {
            GooglePlayGames.OurUtils.Logger.d("AndroidClient.OnRoomCreated, status " + statusCode);
        ...
        private void OnConnectedToRoom(AndroidJavaObject room) {
            GooglePlayGames.OurUtils.Logger.d("AndroidClient.OnConnectedToRoom");
        ...
        private void OnDisconnectedFromRoom(AndroidJavaObject room) {
            GooglePlayGames.OurUtils.Logger.d("AndroidClient.OnDisconnectedFromRoom");
        ...
        private void OnP2PConnected(string participantId) {
            GooglePlayGames.OurUtils.Logger.d("AndroidClient.OnP2PConnected: " + participantId);
        ...
        private void OnP2PDisconnected(string participantId) {
            GooglePlayGames.OurUtils.Logger.d("AndroidClient.OnP2PDisconnected: " + participantId);
        ...
        private void OnPeerDeclined(AndroidJavaObject room, AndroidJavaObject participantIds) {
            GooglePlayGames.OurUtils.Logger.d("AndroidClient.OnPeerDeclined");
        ...
        private void OnPeerInvitedToRoom(AndroidJavaObject room, AndroidJavaObject participantIds) {
            GooglePlayGames.OurUtils.Logger.d("AndroidClient.OnPeerInvitedToRoom");
        ...
        private void OnPeerJoined(AndroidJavaObject room, AndroidJavaObject participantIds) {
            GooglePlayGames.OurUtils.Logger.d("AndroidClient.OnPeerJoined");
        ...
        private void OnPeerLeft(AndroidJavaObject room, AndroidJavaObject participantIds) {
            GooglePlayGames.OurUtils.Logger.d("AndroidClient.OnPeerLeft");
        ...
        private void OnPeersConnected(AndroidJavaObject room, AndroidJavaObject participantIds) {
            GooglePlayGames.OurUtils.Logger.d("AndroidClient.OnPeersConnected");
        ...
        private void OnPeersDisconnected(AndroidJavaObject room, AndroidJavaObject participantIds) {
            GooglePlayGames.OurUtils.Logger.d("AndroidClient.OnPeersDisconnected.");
        ...
        private void OnRoomAutoMatching(AndroidJavaObject room) {
            GooglePlayGames.OurUtils.Logger.d("AndroidClient.OnRoomAutoMatching");
        ...
        private void OnRoomConnecting(AndroidJavaObject room) {
            GooglePlayGames.OurUtils.Logger.d("AndroidClient.OnRoomConnecting.");
        ...
        private void OnRealTimeMessageReceived(AndroidJavaObject message) {
            GooglePlayGames.OurUtils.Logger.d("AndroidClient.OnRealTimeMessageReceived.");
        ...
        private void OnSelectOpponentsResult(bool success, AndroidJavaObject opponents, 
            ...
            GooglePlayGames.OurUtils.Logger.d("AndroidRtmpClient.OnSelectOpponentsResult, success=" + success);
            ...
            if (!success) {
                GooglePlayGames.OurUtils.Logger.w("Room setup failed because select-opponents UI failed.");
            ...
            mClient.CallClientApi("creating room w/ select-opponents result", () => {
                GooglePlayGames.OurUtils.Logger.d("Creating room via support lib's RtmpUtil.");
                AndroidJavaClass rtmpUtil = JavaUtil.GetClass(JavaConsts.SupportRtmpUtilsClass);
        ...
        private void OnInvitationInboxResult(bool success, string invitationId) {
            GooglePlayGames.OurUtils.Logger.d("AndroidRtmpClient.OnInvitationInboxResult, " + 
            ...
            if (!success || invitationId == null || invitationId.Length == 0) {
                GooglePlayGames.OurUtils.Logger.w("Failed to setup room because invitation inbox UI failed.");
            ...
            mClient.CallClientApi("accept invite from inbox", () => {
                GooglePlayGames.OurUtils.Logger.d("Accepting invite from inbox via support lib.");
                AndroidJavaClass rtmpUtil = JavaUtil.GetClass(JavaConsts.SupportRtmpUtilsClass);
                rtmpUtil.CallStatic("accept", mClient.GHManager.GetApiClient(), invitationId,
                                    new RoomUpdateProxy(this), new RoomStatusUpdateProxy(this),
                                    new RealTimeMessageReceivedProxy(this));
        ...
        private void DeliverRoomSetupProgressUpdate() {
            GooglePlayGames.OurUtils.Logger.d("AndroidRtmpClient: DeliverRoomSetupProgressUpdate");
            ...
            GooglePlayGames.OurUtils.Logger.d("room setup progress: " + progress + "%");
            if (mRtmpListener != null) {
                GooglePlayGames.OurUtils.Logger.d("Delivering progress to callback.");
                PlayGamesHelperObject.RunOnGameThread(() => {
        ...
        private class InvitationInboxProxy : AndroidJavaProxy {
            ...
            public void onTurnBasedMatch(AndroidJavaObject match) {
                GooglePlayGames.OurUtils.Logger.e("Bug: RTMP proxy got onTurnBasedMatch(). Shouldn't happen. Ignoring.");
            }
        }
